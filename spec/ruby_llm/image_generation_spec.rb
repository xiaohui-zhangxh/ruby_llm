...
RSpec.describe RubyLLM::Image do
  ...
  describe 'basic functionality' do
    it 'dall-e-3 can paint images' do # rubocop:disable RSpec/MultipleExpectations,RSpec/ExampleLength
    ...
    it 'dall-e-3 supports custom sizes' do # rubocop:disable RSpec/MultipleExpectations,RSpec/ExampleLength
